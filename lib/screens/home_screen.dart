...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      /* lange schreibweise ohne Cascade-Operator
      create: (context) {
        final cubit = ManagePetsCubit(context.read<FirestorePetRepository>());
        cubit.getAllPets();
        return cubit;
      },
      */
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            AdoptionBag(petCount: InheritedAdoptionBag.of(context).petCount)
          ],
        ),
        body: SafeArea(
          child: Padding(
